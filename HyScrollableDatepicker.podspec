#
#  Be sure to run `pod spec lint HyScrollableDatepicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "hopy" => "hopy@livec.cn" }
  # Or just: s.author    = "hopy"
  # s.authors            = { "hopy" => "hopy@livec.cn" }
  # s.social_media_url   = "http://twitter.com/hopy"
